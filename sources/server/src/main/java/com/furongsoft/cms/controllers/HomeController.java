...
import com.furongsoft.cms.addons.companyWebsite.mappers.CompanyDao;
...
public class HomeController {
    ...
    public String initialize() {
        ...
        pTest3.setName("公司信息");
        pTest3.setPath("addons/companyWebsite/company/index.html");
        pTest3.setType(0);
        pTest3.setState(0);
        ...
        pTest4.setName("公司描述");
        pTest4.setPath("addons/companyWebsite/profile/index.html");
        pTest4.setType(0);
        pTest4.setState(0);
        ...
        pTest6.setName("新闻分类");
        pTest6.setPath("addons/companyWebsite/news/category/index.html");
        pTest6.setType(0);
        pTest6.setState(0);
        ...
        pTest7.setName("新闻管理");
        pTest7.setPath("addons/companyWebsite/news/index.html");
        pTest7.setType(0);
        pTest7.setState(0);
        ...
        pTest8.setName("招聘信息");
        pTest8.setPath("addons/companyWebsite/job/index.html");
        pTest8.setType(0);
        pTest8.setState(0);
        ...
        pTest9.setName("产品分类");
        pTest9.setPath("addons/companyWebsite/product/category/index.html");
        pTest9.setType(0);
        pTest9.setState(0);
        ...
        pTest10.setPath("addons/companyWebsite/product/index.html");
        pTest10.setType(0);
        pTest10.setState(0);
